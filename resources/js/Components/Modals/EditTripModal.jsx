...
import { Truck, User, X, Send, MapPin, Loader2, Edit3, Package, FileText } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs z-50 flex items-center justify-center p-3 sm:p-4 animate-in fade-in duration-150">
            <div className="bg-white border border-slate-200 rounded-3xl w-full max-w-lg p-5 sm:p-6 shadow-2xl space-y-4 text-slate-800 relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-3.5 text-xs">
                    ...
                    <div>
                        <label className="text-slate-700 block mb-1 font-bold">Catatan Rute / Instruksi Pengiriman:</label>
                        <input 
                            type="text" 
                            value={notes} 
