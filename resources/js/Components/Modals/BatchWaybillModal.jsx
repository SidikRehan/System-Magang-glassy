                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="text-[11px] bg-white p-2.5 rounded-xl border border-slate-300 text-slate-800 space-y-1.5">
                                        <div>
                                            <strong>Catatan Pengiriman Standard:</strong> Barang kaca telah diperiksa dalam kondisi sempurna (tidak pecah/gurat) sebelum dimuat ke armada pengiriman. Mohon periksa kembali saat penerimaan di lokasi Stop #{ordIdx + 1}.
                                        </div>
                                        {(ord.notes || ord.delivery?.notes) && (
                                            <div className="bg-amber-50 border border-amber-200 p-2 rounded-lg text-amber-900 font-medium">
                                                ...
                                                <p className="whitespace-pre-line leading-relaxed">{ord.notes || ord.delivery?.notes}</p>
                                            </div>
                                        )}
                                    </div>
